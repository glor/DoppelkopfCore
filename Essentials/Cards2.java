 ...
 * @author Jonas
 */
public class Cards2 implements dokoCore.Interfaces.Settings, Comparable<Cards2> {
    ...
    public Cards2 (int color, int pointValue){
        setColor(color);
   ...
   public Cards2 (Cards2 card){
    ...
    //
    @Override 
    public int compareTo(Cards2 card){
    ...
    public boolean equals(Object o){
        if(o==null)
            return false;
        if(o instanceof Cards2)
            return (((Cards2)o).getColor()==getColor())&&(((Cards2)o).getPointValue()== getPointValue());
        return false;
    }
